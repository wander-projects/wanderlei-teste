    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/activity')) {
            ...
            if (rtrim($pathinfo, '/') === '/activity') {
                ...
                return array (  '_controller' => 'AppBundle\\Controller\\ActivityController::indexAction',  '_route' => 'activity_index',);
            }
            not_activity_index:
            ...
            if ($pathinfo === '/activity/new') {
                ...
                return array (  '_controller' => 'AppBundle\\Controller\\ActivityController::newAction',  '_route' => 'activity_new',);
            }
            not_activity_new:
            ...
            if (preg_match('#^/activity/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'activity_show')), array (  '_controller' => 'AppBundle\\Controller\\ActivityController::showAction',));
            }
            not_activity_show:
            ...
            if (preg_match('#^/activity/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'activity_edit')), array (  '_controller' => 'AppBundle\\Controller\\ActivityController::editAction',));
            }
            not_activity_edit:
